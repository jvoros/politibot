...
export interface Callback {
  (err: any, result: any, response: any): void
}
...
export declare class Twit {
  ...
  get(path: string, params: Params, callback: Callback): void;
  get(path: string, params?: Params): Promise<PromiseResponse>;

  /**
   * @see https://github.com/ttezel/twit#tpostpath-params-callback
   */
  post(path: string, callback: Callback): void;
  post(path: string, params: Params, callback: Callback): void;
  post(path: string, params?: Params): Promise<PromiseResponse>;

  /**
   * @see https://github.com/ttezel/twit#tpostmediachunkedparams-callback
   */
  postMediaChunked(media: MediaParam, callback: Callback): void;
   ...
   */
  setAuth(tokens: ConfigKeys): void

  /**
   * @see https://github.com/ttezel/twit#tstreampath-params
   */
  stream(path: StreamEndpoint, params?: Params): Stream;
}
